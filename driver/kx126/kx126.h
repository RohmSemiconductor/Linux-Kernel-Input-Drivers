...
#define KX126_DEV_NAME "kx126"

/* -/+ 2g */
#define KX126_ACC_RANGE_2G (2)
/* -/+ 4g */
#define KX126_ACC_RANGE_4G (4)
/* -/+ 8g */
#define KX126_ACC_RANGE_8G (8)

#define KX126_ACC_RANGE_DEFAULT 	KX126_ACC_RANGE_4G

struct kx126_platform_data {
	int (*init)(void);
	void (*release)(void);
	 ...
	 * the accelerometer output. Use the KX126_G_RANGE_XX
